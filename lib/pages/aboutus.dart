...
class _AboutusPageState extends State<AboutusPage> {
  ...
  Widget build(BuildContext context) {
    Future<void> sendEmail() async {
      ...
      if (await UrlLauncher.canLaunchUrl(emailLaunchUri)) {
        await UrlLauncher.launchUrl(emailLaunchUri);
      } else {
        // Handle the case where the user doesn't have an email app
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                        onPressed: () {
                          UrlLauncher.launchUrl(Uri.parse('tel: +6590056481'));
                        },
                        child: const Text("90056481"))
                  ],
                ),
                const SizedBox(
                  height: 15,
                    ...
                    child: TextField(
                      decoration: const InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                                color: ColorExtensions.lightPurple,
                                width: 2.0)),
                      ),
